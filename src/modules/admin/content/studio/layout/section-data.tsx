...
export function SectionData({
  ...
  return (
    <div className={cn(panel, 'min-h-[calc(100vh-150px)] overflow-hidden rounded-[8px] bg-white text-[#152033]')}>
      ...
      {!selectedItem ? (
        <div className="grid min-h-[calc(100vh-220px)] place-items-center p-6 text-center">
          <div>
